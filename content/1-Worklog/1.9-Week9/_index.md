...
* Shift mindset from "ClickOps" (manual clicking) to "IaC" (Infrastructure as Code).
* Use AWS CDK to define infrastructure.
...
| 6   | - Execute `cdk destroy` to clean up resources. Understand Drift detection. | 07/11/2025 | 07/11/2025 |


### Week 9 Achievements:

* Understood the benefits of IaC in version control and infrastructure reusability.
