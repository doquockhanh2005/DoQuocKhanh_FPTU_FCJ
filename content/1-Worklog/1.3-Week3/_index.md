...
* Understand EC2 virtual server services and EBS volume types.
* Understand High Availability and Scalability concepts.
* **Practice:** Deploy a web server with Load Balancer and Auto Scaling.
...
* Successfully deployed a basic Web Server on EC2.
